...
{{<image src="/docs/images/webhooks/image1.png" title="Webhook flow" width="624" height="212">}}
...
{{<image src="/docs/images/webhooks/image2.png" title="dashboard settings" width="291" height="132">}}
...
{{<image src="/docs/images/webhooks/image3.png" title="webhook field" width="332" height="112">}}
...
{{<image src="/docs/images/webhooks/image4.png"  title="webhook.site test" width="324" height="129">}}
...
{{<image src="/docs/images/webhooks/image5.png" title="Jira Project Settings" width="624" height="463">}}
...
{{<image src="/docs/images/webhooks/image6.png" title="Jira Automation" width="624" height="193">}}
...
{{<image src="/docs/images/webhooks/image7.png" title="Webhook Trigger" width="624" height="162">}}
...
{{<image src="/docs/images/webhooks/image8.png" title="Incoming webhook URL" width="624" height="252">}}
...
{{<image src="/docs/images/webhooks/image9.png"  title="Create issue" width="624" height="241">}}
...
{{<image src="/docs/images/webhooks/image10.png" title="Disabled webhook" width="624" height="116">}}
...
{{<image src="/docs/images/webhooks/image11.png" title="Invalid webhook email warning" width="624" height="604">}}
...
{{<image src="/docs/images/webhooks/image12.png" title="Final webhook email warning" width="624" height="666">}}

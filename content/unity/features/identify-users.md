...
1. [**User Personas**]({{< relref "/unity/features/identify-users#user-personas" >}}). This is data you can set and update about the user of a session.
...
```csharp
Embrace.Instance.SetUserIdentifier("internal_user_id_1234");
```

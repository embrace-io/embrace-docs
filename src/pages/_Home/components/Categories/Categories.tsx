...
const Categories = () => {
  ...
  const categories: Record<Categories, HomeCardProps[]> = useMemo(() => {
    const defaultTablerIconProps = {
      size: 24,
      stroke: 1.5,
      color:
        colorMode === "dark" ? "var(--brand-primary)" : "var(--brand-lead)",
    };
    ...
    return {
      Essentials: [
        ...
        },
        {
          ...
          icon: <IconCheck {...defaultTablerIconProps} />,
          linkTo: "/best-practices",
        },
        {
          title: "Tutorials",
          description:
            "Check out our tutorials to easily learn about our product.",
          icon: <IconBrandYoutube {...defaultTablerIconProps} />,
      ...
      "Open Telemetry": [
        ...
        },
        {
          ...
          icon: <IconTimelineEventExclamation {...defaultTablerIconProps} />,
        ...
        },
        {
          ...
          icon: <IconSdk {...defaultTablerIconProps} />,
      ...
      "Data Forwarding": [
        {
          ...
          icon: <IconPuzzle {...defaultTablerIconProps} />,
        ...
        },
        {
          ...
          icon: <IconChartArrows {...defaultTablerIconProps} />,
        ...
        // TODO: review
        {
          ...
          icon: <IconLayoutGridAdd {...defaultTablerIconProps} />,
      ...
      Features: [
        {
          ...
          icon: <IconUsersGroup {...defaultTablerIconProps} />,
        ...
        },
        {
          ...
          icon: <IconFlame {...defaultTablerIconProps} />,
        ...
        },
        {
          ...
          icon: <IconDeviceMobileX {...defaultTablerIconProps} />,

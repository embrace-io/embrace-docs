...
| The group ID for the ANR.<br /><span class="filters-table__key">group_id</span> | — | String | — |
...
| Message<br /><span class="filters-table__key">log_raw_msg</span> | Message describing the crash. | String | — |
| Message<br /><span class="filters-table__key">raw_msg</span> | Message describing the crash. | String | — |
| The group ID for the ANR.<br /><span class="filters-table__key">log_group_id</span> | — | String | — |

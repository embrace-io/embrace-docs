...
| Site ID<br /><code class="filters-table__key">site_id</code> | SpeedCurve site identifier. Name resolution is handled by the application layer via the SpeedCurve MySQL database. | int | — |
| Test Profile<br /><code class="filters-table__key">test_profile_name</code> | Browser/device profile used for testing. | String | — |

...
## Overview
The initial view of Synthetics begins with an overview, showing the performance across ALL of the sites you have configured. The dashboards a built to be interactive. For example, clicking on the Site name will open your next view, the Site dashboard.

![Synthetics overview dashboard with dark background displaying a data table containing site names in the first column and color-coded performance metrics across multiple columns, providing an at-a-glance view of all configured site performance](/static/images/synthetics/syn-overview.png)

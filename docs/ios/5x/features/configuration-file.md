...
#### `CRASH_REPORT_PROVIDER` _string, optional_
...
##### `CAPTURE_COORDINATES` _boolean, optional_
...
##### `CAPTURE_TAPPED_ELEMENTS` _boolean, optional_
...
##### `ENABLE_WK_AUTO_RELOAD` _boolean, optional_
...
##### `DISABLED_URL_PATTERNS` _array\[string\], optional_
...
##### `URLSESSION_CAPTURE_FILTERS` _array\[string\], optional_
...
##### `STARTUP_AUTOEND_SECONDS` _int, optional_
...
##### `WEBVIEW_STRIP_QUERYPARAMS` _boolean, optional_
...
##### `WEBVIEW_ENABLE` _boolean, optional_
...
###### `NETWORK:DOMAINS` _dictionary\[string, int\], optional_
...
###### `NETWORK:CAPTURE_PUBLIC_KEY` _string, optional_
...
##### `MAX_SESSION_SECONDS` _boolean, optional_
...
##### `TRACE_ID_HEADER_NAME` _string, optional_
...
##### `PUSH_NOTIFICATIONS_CAPTURE_MODE` _string, optional_
...
##### `ENABLE_PUSH_NOTIFICATIONS_DATA_CAPTURE` _boolean, optional_
...
##### `CUSTOM_PATH_HEADER_INFO` _dictionary, optional_

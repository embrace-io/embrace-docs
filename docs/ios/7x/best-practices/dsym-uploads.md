...
description: Best practices for automating dSYM uploads with the Embrace iOS SDK 7.x
sidebar_position: 5
---
...
### Key Changes in iOS SDK 7.x

**Important:** Starting with iOS SDK 7.x, the dSYM upload scripts are no longer bundled with the SDK package. Make sure to change your CI scripts to download and unzip the support utility from https://downloads.embrace.io/embrace_support.zip

For complete setup instructions, see [dSYM Upload](/ios/7x/getting-started/dsym-upload).

---
title: Core Concepts
description: Fundamental concepts of the Embrace iOS SDK 7.x
sidebar_position: 2
---

## Core Concepts

This section explains the fundamental concepts and components that make up the Embrace iOS SDK 7.x. Understanding these core concepts will help you better utilize the SDK's capabilities and interpret the data it provides.
...
The Embrace iOS SDK 7.x is built on the OpenTelemetry framework, an industry-standard approach to observability. This means:

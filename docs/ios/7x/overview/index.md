---
title: Introduction
description: Introduction to the Embrace iOS SDK 7.x
sidebar_position: 0
---

## Introduction to Embrace iOS SDK 7.x

The Embrace 7.x Apple SDK is designed to provide first-class observability and diagnostic data collection to your mobile application. It supports multiple platforms including iOS, iPadOS, tvOS, macOS, and watchOS.

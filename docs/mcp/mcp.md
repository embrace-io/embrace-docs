...
| Cursor         | Reference Cursor's official documenation for [Remote Server](https://cursor.com/docs/context/mcp) configurations. NOTE: do not include `headers` property and follow the authorization flow in Tools & MCP once you save the configuration in `mcp.json`.                                                         |

...
2. You can also pull the latest set of supported metrics directly from the [API](https://embrace.io/docs/custom-metrics-api/#get-metrics-and-parameters-supported).
...
Metrics API or can be forwarded into your data destination of choice.
...
aggregated. We automatically aggregate your metrics into Prometheus style metrics (provide link to Prometheus concepts)
...
amongst paying customers. You can then consume this metric in your datastore of choice (example below is Grafana /
prometheus).

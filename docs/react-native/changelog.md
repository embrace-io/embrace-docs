...
## 5.2.0
_January 03, 2025_
* Published new `@embrace-io/react-native-otlp` package that allows to send the data to a Backend of preference (besides Embrace) following the OTLP-http protocols.

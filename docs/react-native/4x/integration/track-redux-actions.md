...
:::info
Currently we are only supporting the Redux SDK and other libraries that support middleware such as Saga, if you are using another library please contact us at [support@embrace.com](mailto:support@embrace.com) or on Slack if you would like to request support.
:::

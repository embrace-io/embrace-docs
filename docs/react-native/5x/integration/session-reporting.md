...
`sdkConfig.ios` are ignored. Additional configuration can be applied when setting up the iOS SDK in the [configuration steps](/docs/ios/6x/api-reference/configuration.md).
:::

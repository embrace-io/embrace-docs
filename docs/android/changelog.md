...
- API and functional changes in this major release are documented in the [Upgrade Guide](/android/upgrading/). Key ones to be aware of include:
    - Moments feature and API have been removed in favor of [Performance Tracing](/android/features/traces/), which should be used instead to track how long workflows in the app took to complete.
...
- New features and other changes in this release include:
    ...
    - Auto-termination of Performance Tracing spans based on navigation

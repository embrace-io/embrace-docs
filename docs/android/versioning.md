...
To provide the best experience — modern APIs, better performance, and faster support — the SDK intentionally follows the evolution of the Android toolchain. While aiming to minimize disruption and support a reasonable range of versions, occasional updates are necessary.

---

## Our versioning principles

The SDK follows these principles to stay aligned with the Android ecosystem:
...
The SDK sets `sourceCompatibility = 11` and relies on **desugaring**, which allows your app with lower `minSdk` values to use modern Java 11+ language features. More info: [Java 8+ desugaring in Android Studio](https://developer.android.com/studio/write/java8-support)
